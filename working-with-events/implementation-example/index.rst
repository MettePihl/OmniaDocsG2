...
Reservations is possible and there's one name on that list, waiting for the possibility that one of the registered participants will not be able to attend.
