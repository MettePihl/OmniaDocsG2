Set up Omnia in Microsoft Teams
===============================

Here's how to set up Omnia in Microsoft Teams.
...
**Note!** If you receive a sign-in error, you should contact support. Then some manual settings probably need to be done in the Azure AD app.
 
